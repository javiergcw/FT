...
const Inicio = () => {
  return (
    <>
      ...
      <main className="container px-16 mx-auto">
        <div className="grid grid-flow-col justify-between auto-cols-max ">
          <div className="py-8">
            <Image src="/images/Logo.svg" width={400} height={32} />
          </div>
          ...
          <div className="py-8">
            <div className="relative w-full grid grid-flow-col auto-cols-max object-center">
              ...
              <button
                type="submit"
                className=" p-2.5 w-20 h-12  text-sm font-medium  text-white bg-blue-700 rounded-r-lg  hover:bg-blue-800  focus:ring-blue-300 border-1"
              >
                <div className="pl-3">
                  <Image
                    className=""
          ...
          <div className="grid grid-flow-col w-48 pt-6  ">
            <div className="content-center text-[#091535] font-semibold ">
              <div className="grid grid-flow-row place-content-center pl-1 w-14 h-14">
                ...
                <div className="pl-4">
                  <button className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300  font-medium rounded-lg text-sm w-14 h-14 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    <Image
                      className="mx-auto"
            ...
            <div className="content-center text-[#091535] font-semibold ">
              <div className="grid grid-flow-row place-content-center pl-1 w-14 h-14">
                ...
                <div className="pl-3">
                  <button
                    type="button"
                    class=" text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-16 h-14 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                  >
                    <Image
      ...
      <main className="container px-16 mx-auto">
        <div className="flex py-4">
          <div className="w-2/3">
            <button
              type="button"
              class="text-white bg-[#0F51FA] hover:bg-[#0F51FA]/80 focus:ring-4 focus:outline-none focus:ring-[#0F51FA]/50 font-medium rounded-lg text-sm px-5 py-2.5 w-48 h-9 text-center inline-flex items-center  mr-2 mb-2"
            >
              <SlMenu className="" />
              <p className="px-6 text-base ">Categorias</p>
              <SlArrowDown />
            </button>
          </div>
          <div className="w-1/2" />
          {Links.map((item, index) => (
            <div className="grid grid-flow-col text-center text-base text-[#637381]">
